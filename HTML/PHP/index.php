...
<meta name="author" content="FullDynamic">
<meta name="DC.creator " content="FullDynamic"/>
<meta name="Custodian" content="FullDynamic"/>
<meta name="DC.date.created" content="2022-11-22"/>
<meta name="DC.Identifier" content="http://www.fulldynamic.com.br">      
<meta name="DC.creator.address" content="contato@fulldynamic.com.br"/>
<meta name="DC.format" content="text/xhtml"/>
<meta name="DC.publisher" content="FullDynamic"/>
<meta name="copyright" content="© 2022 tex texin"/>
<meta name="generator" content="Visual Studio Code"/>
<meta name="DC.type" content="text.homepage.image.video.menu"/>
<meta http-equiv="content-script-type" content="text/javascript"/>
<meta http-equiv="content-style-type" content="text/css"/>
<meta name="DC.title" content="Bruno Mussati - BM Support">
<meta name="DC.description" content="Bruno Mussati - BM Support"/>
<meta name="keywords" content="python, web design, ssl, dns, sql, wordpress, software, developer, application">
<meta name="DC.subject" content="python, web design, ssl, dns, sql, wordpress, software, developer, application"/>

<meta http-equiv="content-language" content="pt-BR, en-US, fr"/>
<meta name="distribution" content="global">
<meta name="subject" content="BM Support - Bruno Mussati">
<meta name="classification" content="BM Support - Bruno Mussati">
<meta name="subtitle" content="BM Support - Bruno Mussati">

<meta name="robots" content="index,follow">
<meta property="og:region" content="Ireland">
<meta property="og:url" content="https://www.bmsupport.ie">
<meta name="thumbnail" content="https://www.bmsupport.ie/imgs/bm-support-fulldynamic.webp">
<meta property="og:image" content="https://www.bmsupport.ie/imgs/bm-support-fulldynamic.webp">
<meta property="og:title" content="BM Support - Bruno Mussati"/>
<meta property="og:type" content="website"/>
<meta property="og:locale" content="pt_BR">
<meta property="og:description" content="python, web design, ssl, dns, sql, wordpress, software, developer, application"/>

    <title>Bruno Mussati - BM Support</title>
...
<body>
    ...
    <section class="fullFULL">
<a href="https://fulldynamic.com.br"><p>fulldynamic agência de marketing digital</p></a>
     <a href="https://dlcadvogados.com.br"><p>dlc advogados</p></a>
     <a href="https://escritoriobm.com.br"><p>maybi brogliatto, escritório bm</p></a>
     <a href="https://emagrecimentojussaramunareto.com"><p>dra. jussara munareto</p></a>
     <a href="https://climaoarcondicionado.com.br"><p>climão ar condicionado</p></a>
     <a href="https://venomgrafica.com.br"><p>venom gráfica</p></a>
     <a href="https://estofadordazonasulrj.com.br/"><p>maim estofador</p></a>
     <a href="https://impressorampinfo.com.br/"><p>mpinfo impressoras</p></a>
     <a href="https://projetosolarium.com.br/"><p>projeto solarium</p></a>
     <a href="https://cursoscda.com.br"><p>instituto cda , cursos cda</p></a>
     <a href="https://teixeirao.com/"><p>teixeirão serviços essenciais</p></a>     
     <a href="https://desentupidorawin.com.br/"><p>desentupidora win</p></a>
     <a href="https://jocielcorretor.com.br/"><p>jociel corretor</p></a> 
     <a href="https://bmsupport.ie"><p>bm support, Bruno Mussati</p></a>       
     <a href="https://zapada.com.br/"><p>loja zapada oficial</p></a>  </section>
    ...
    <header id="topo"> <a class="botTOP wobble-bottom" href="#slid"> <span class="icon-home"></span>Home</a> <a class="botTOP wobble-bottom" href="#sobr"><span class="icon-thumbs-up-alt"></span>Differentials</a> <a class="botTOP wobble-bottom" href="#exp"><span class="icon-graduation-cap"></span>Qualifications</a> <section>   <a class=" wobble-bottom" href=""><span class="icon-facebook-official"></span></a> <a class=" wobble-bottom" href=""><span class="icon-instagram"></span></a> <a class=" wobble-bottom" href=""><span class="icon-whatsapp"></span></a> </section> </header>

  <section id="slid" class="intro">

    <img src="imgs/bm-support-fulldynamic-02.webp" alt="">
   
    <section id="exttSLID">
        <section class="content">
            <section class="content__container">
              <h1 class="content__container__text">Bruno Mussati</h1>
              
              <ul class="content__container__list">
                <li class="content__container__list__item">Punctuality</li>
                <li class="content__container__list__item">Creative</li>
                <li class="content__container__list__item">Agile</li>
                <li class="content__container__list__item">Interactive</li>
              </ul>
            </section>
          </section>
    </section>
  ...
  <section id="sobr">
    <span id="imgSOBR" class="anime anime-start"></span>
    <h2 class="titPADR anime anime-start">About me - Bruno Mussati</h2>
    <section id="exttSOBR">
        <section class="anime anime-start">
            <p class="subtitPADR">It is a great pleasure to welcome you to my page. <span> I am Brazilian, I am 29 years old and I have lived in Northern Ireland for 7 years.</span> I have always been passionate about technology, I am studying the XXXXXXXX course, I am in the second semester and will finish in 2024. I would be very grateful to receive a opportunity, I promise to give my best always !!!
            </p>
        </section>
    </section>
  </section>
  ...
  <section id="qual">
    <section class="anime anime-start"><p class="titPADR2">Dedication<span class="icon-thumbs-up-alt"></span> </p> <p class="descPADR">In everything I do, I always dedicate myself 100%</p> </section>
    <section class="anime anime-start"><p class="titPADR2">Agility<span class="icon-rocket-1"></span> </p> <p class="descPADR">I stand out in agility, maintaining the quality</p> </section>
    <section class="anime anime-start"><p class="titPADR2">Proactive<span class="icon-child"></span> </p> <p class="descPADR">I'm willing to help at all times</p> </section> 
    <section class="anime anime-start"><p class="titPADR2">Patience<span class="icon-hourglass-2"></span> </p> <p class="descPADR">One of my greatest strengths is patience.</p> </section>  
  </section>

  <section id="exp">
    <h3 class="titPADR anime anime-start">Find out about my qualifications</h3> <span class="BMSUP anime anime-start">#BMSUPPORT</span> 
    <section id="exttEXP">
    <section class="anime anime-start"><p class="titPADR2">Computing</p> <p class="descPADR">Intermediary</p> <p class="datEXP">7 years</p> </section>
    <section class="anime anime-start"><p class="titPADR2">HTML/CSS</p> <p class="descPADR">Basic</p> <p class="datEXP">1 year</p> </section>
    <section class="anime anime-start"><p class="titPADR2">Python</p> <p class="descPADR">Basic</p> <p class="datEXP">1 year</p> </section>
    <section class="anime anime-start"><p class="titPADR2">WordPress</p> <p class="descPADR">Basic</p> <p class="datEXP">1 year</p> </section>
    <section class="anime anime-start"><p class="titPADR2">DNSS/SSL</p> <p class="descPADR">Basic</p> <p class="datEXP">1 year</p> </section>
    <section class="anime anime-start"><p class="titPADR2">SQL</p> <p class="descPADR">Basic</p> <p class="datEXP">1 year</p> </section>
      </section>
...
<div class="container">
  ...
  <section id="hab">
    <h4 class="titPADR anime anime-start">Professional pretensions that I am interested in</h4> <span class="BMSUP anime anime-start">#BMSUPPORT</span> 
    <section id="exttHAB">
    <section class="wobble-bottom"><p class="titPADR2">Python</p> <span class="icon-code"></span> </section> <section class="wobble-bottom"><p class="titPADR2">Web design</p><span class="icon-desktop"></span></section> <section class="wobble-bottom"><p class="titPADR2">Software developer</p><span class="icon-mobile"></span></section> <section class="wobble-bottom"><p class="titPADR2">Software APP</p><span class="icon-off"></span></section> <section class="wobble-bottom"><p class="titPADR2">WordPress</p><span class="icon-wordpress"></span></section>
    <section class="wobble-bottom"><p class="titPADR2">DNS/SSL</p><span class="icon-sitemap"></span></section>
    <section class="wobble-bottom"><p class="titPADR2">SQL</p><span class="icon-database"></span></section>
  </section>
</section>

<footer id="roda">        
  <div id="dirFT">
  <p id="dirFULL">ALL RIGHTS RESERVED - BRUNO MUSSATI BM SUPPORT - 22</p><a href="https://www.fulldynamic.com.br" id="FULLRDP" title="by FullDynamic"> </a>         
   </div>
  </footer>
